...
#       I am do it. I create a series of chunk\d.dat files where \d is the
#       rank of the process and then I have root read them back in and stack.
#       I then delete the file. Cheating, but effective and clever

my_save_name = '##chunk%s.db##' % (rank)
